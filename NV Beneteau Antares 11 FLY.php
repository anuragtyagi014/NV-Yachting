...
/* 
Template Name: NV Beneteau Antares 11 FLY Template
*/

get_header();

?>
<section class="page-template-NVBeneteauAntares11">


<section class="page-template-NVBeneteauAntares8Fishing">
...
?>
    <section class="targa-main-img" data-aos="zoom-in-up">
        ...
        <video src="<?= get_field('file'); ?>" autoplay muted playsinline loop></video>

        <?php endif; ?>
         <?php if (get_field('file_type') == 'image') : ?>
         <img src="<?= get_field('file');?>" alt="">
          <?php endif; ?>
    </section>
...
?>
   <!--  <section class="round-view" data-aos="zoom-in-up">
        <div class="o-pano-container current visit-v3" data-boat="AT9LA007"><iframe src="<//?= //get_field('video_frame');?>" title="Visite 360" data-gtm-yt-inspected-9370839_257="true"></iframe></div>
    </section> -->
<?php
...
?>
    <section class="phone-dek" data-aos="zoom-in-up">
        ...
        <div class="desk-tabs-phne">
         ...
         ?>
      <!--       <div class="tabs-info-phone">
                <img src="https://nvyachting.com/wp-content/uploads/2022/12/Image-13.png" class="img-fluid" alt="">
                <div class="model-e-cont">
                    <h4>INNOVATIONS</h4>
                    <p>Her many innovative solutions ensure a high level of comfort: aft sun bench, side swim platform creating a sea-view terrace, and aft cockpit which flow naturally into the wheelhouse.</p>
                </div>
            </div>
            <div class="tabs-info-phone">
                <img src="https://nvyachting.com/wp-content/uploads/2022/12/Image-1.png" class="img-fluid" alt="">
                <div class="model-e-cont">
                    <h4>SAFETY</h4>
                    <p>High freeboards and large walkways allow for easy access to all corners of the spacious Antares 11.</p>
                </div>
            </div>
            <div class="tabs-info-phone">
            <img src="https://nvyachting.com/wp-content/uploads/2022/12/Image-2.png" class="img-fluid" alt="">
                    <div class="model-e-cont">
                        <h4>PERFORMANCE</h4>
                        <p>Twin Mercury 300 V-8s pair perfectly with the hull offering a smooth, dry and efficient ride. When combined with optional joystick piloting, the Antares 11 is nimble even in the tightest of marinas.</p>
                    </div>
            </div> -->
        </div>
    </section>
