...
/* 
Template Name: De Antonio D28 Xplorer Template
*/
...
?>
        ...
        <section class="targa-main-img" data-aos="zoom-in-up">
            ...
            <!-- <img src="https://nvyachting.com/wp-content/uploads/2022/12/S58-Carousel-1-l-s-scaled-2300x1285-17.png" class="img-fluid" alt=""> -->
...
if (have_rows('interior_design_section_content_')) :
    while (have_rows('interior_design_section_content_')) : the_row();
        if (get_row_layout() == 'all_content') :
?>
        <section class="luxuray-social second-sec explorer">
            <div class="row">
                <div class="col-md-6" data-aos="fade-up">
                    <div class="headinigg">
                        <?= get_sub_field('heading'); ?>
...
?>
        ...
        <section class="targa-main-img spec-img-except" data-aos="zoom-in-up">
            <img src="<?= the_field('desktop_boat_image'); ?>" class="model-numm excep-desk-33" alt="">
            <img src="<?= the_field('mobile_boat_image'); ?>" alt="" class="excep-phone-33">
        </section>
        ...
        <section class="targa-main-img spec-img-except bg-custom">
            ...
            <div class="row" data-aos="zoom-in-up">
                <div class="col-12">
                    <h2><?= the_field('specification_main_heading');?></h2>
                </div>
            </div>
