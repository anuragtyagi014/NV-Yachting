...
/* 
Template Name: NV Beneteau Antares 8 Fishing Template
*/
...
<section class="targa-main-img" data-aos="zoom-in-up">
   <!--<img src="<//?= //the_field('image_middle'); ?>" alt="">-->
  <video src="<?= the_field('image_middle'); ?>" muted autoplay loop></video>
</section>
