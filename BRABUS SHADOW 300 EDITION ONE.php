...
/* 
Template Name: BRABUS SHADOW 300 EDITION ONE Template
*/
...
?>
            ...
            <video src="https://nvyachting.com/wp-content/uploads/2023/01/Jobe-X-Brabus-v9_converted1-1.mp4" playsinline muted loop autoplay></video>
            <?php }else{ ?>
...
?>
        <section class="targa-gallery second-sec">
            <div class="gallery-par">
                <div class="gallery-l">
                    <div class="gallery-imgg" data-aos="zoom-in-up">
...
<?php
if (have_rows('multi_function_section_content')) :
    while (have_rows('multi_function_section_content')) : the_row();
        if (get_row_layout() == 'all_content') :
?>
        <section class="luxuray-social second-sec open-42">
            <div class="row">
...
?>
        ...
        <section class="new-spec" data-aos="fade-up">
            <div class="row">
                <div class="col-12">
