...
/* 
Template Name: NV Beneteau Flyer 9 Sundeck Template
*/
...
<section class="targa-main-img" data-aos="zoom-in-up">
    <!-- <img src="https://nvyachting.com/wp-content/uploads/2022/12/Mask-Group-1.png" class="img-fluid" alt=""> -->
    <video src="<?= the_field('image_middle'); ?>" autoplay muted loop playsinline></video>
</section>
...
<div class="row">
  ...
  <!--       <div class="tabs-info-phone">
        ...
        <img src="https://nvyachting.com/wp-content/uploads/2022/12/Image-109.png" class="img-fluid" alt="">
                <div class="model-e-cont">
                    <h4>Cooking on board </h4>
                    <p>A complete exterior galley, well-integrated and protected by the wide windshield, allows you to cook on board easily.</p>
                </div>
        </div> -->
    </div>
</section>
