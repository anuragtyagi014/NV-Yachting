...
/* 
Template Name: Squadron 50 Template
*/
    ...
    <div class="row" data-aos="zoom-in-up">
        <div class="col-12 text-center">
            <div class="logo-tile">
                ...
                <!-- <h1>SQUADRON<strong>50</strong></h1> -->
...
<section class="targa-gallery second-sec">
    ...
    <div class="gallery-par">
        <div class="gallery-l" data-aos="zoom-in-up">
            <div class="gallery-imgg">
                <img src="<?= get_sub_field('gallery_image_right_2'); ?>" class="img-fluid circle-phn excp-1 excp_50" alt="">
            </div>
        </div>
        <div class="gallery-r" data-aos="zoom-in-up">
            <div class="gallery-imgg">
...
<section class="row vert_pad row-iframe row_index-8 " data-aos="zoom-in-up">
    <a id="anchor-8" class="section_anchor"></a>

    <div class="content_wrapper">
        <div class="iframe_embed_container js-ratio_size_container viewport_check viewport_check-up vh-100 in_viewport" data-ratio-width="640" data-ratio-height="360" style="height: 390px;">
            <iframe src="<?= the_field('iframe_source_link'); ?>" class="iframe_embed" frameborder="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen=""></iframe>
        </div>
    </div>
</section>
...
<section class="desk-tabs" data-aos="zoom-in-up">
    ...
    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="pills-profile-tab" data-toggle="pill" data-target="#pills-upper-deck" type="button" role="tab" aria-controls="pills-profile" aria-selected="false"><?= get_sub_field('button_6') ?></button>
        </li>
    </ul>
    <div class="tab-content" id="pills-tabContent">
        ...
        <div class="tab-pane fade" id="pills-upper-deck" role="tabpanel" aria-labelledby="pills-contact-tab">
            <div class="boat-targa-img">
