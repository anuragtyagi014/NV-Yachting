...
/* 
Template Name: NV Beneteau Antares 11 Template
*/
...
<section class="targa-main-img" data-aos="zoom-in-up">
    <!-- <img src="https://nvyachting.com/wp-content/uploads/2022/12/S58-Carousel-1-l-s-scaled-2300x1285-2.png" alt=""> -->
    <video src="<?= the_field('image_middle'); ?>" autoplay loop muted playsinline></video>
</section>
...
<div class="o-pano-container current visit-v3" data-boat="AT9LA000"><iframe src="<?= get_field('video_frame');?>" title="Visite 360" data-gtm-yt-inspected-9370839_257="true"></iframe></div>
</section>
<?php
