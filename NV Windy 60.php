...
/* 
Template Name: NV Windy 60 Template
*/
...
<section class="page-template-NVWindy52">
...
if (have_rows('main_logo_image_area')) :
    ...
    <div class="main-logo-img"  data-aos="zoom-in-up">
        <div class="main-logo-flex">
            ...
            <!-- <video src="https://nvyachting.com/wp-content/uploads/2023/02/Windy-SLR_SR60-1.mp4" playsinline autoplay loop muted></video> -->
            <p><?= get_sub_field('text1'); ?> <strong><?= get_sub_field('strong_text'); ?> </strong></p>
        </div>
    </div>
<?php
        endif;
...
<?php
if (have_rows('brand_info_area_3')) :
    while (have_rows('brand_info_area_3')) : the_row();
        if (get_row_layout() == 'all_content') :
?>
    <div class="brand-info b28"  data-aos="zoom-in-up">
         <?= get_sub_field('para'); ?>
...
<?php
if (have_rows('brand_info_area_4')) :
    while (have_rows('brand_info_area_4')) : the_row();
        if (get_row_layout() == 'all_content') :
?>
    <div class="brand-info b28"  data-aos="zoom-in-up">
